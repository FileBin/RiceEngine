    ...
    class Command {
      public:
        ...
        struct ArgIterator {
            ...
            ArgIterator(Arg *arg) { current = arg; }
            ...
            Arg &operator*() { return *current; }

            ArgIterator operator++(int) {
                ArgIterator tmp = *this;
                ++(*this);
                return tmp;
            }
        };

        template <typename T> struct TypedArg : public Arg {
            T data;
      ...
      private:
        template <typename... ArgsT> struct __convert_args {
