...
vk::CommandPoolCreateInfo VulkanHelper::command_pool_create_info(uint queueFamilyIndex,
...
vk::CommandBufferAllocateInfo VulkanHelper::command_buffer_allocate_info(vk::CommandPool pool, uint count,
...
vk::PipelineShaderStageCreateInfo VulkanHelper::pipeline_shader_stage_create_info(vk::ShaderStageFlagBits stage,
...
VulkanHelper::vertex_input_state_create_info(vec<vk::VertexInputBindingDescription> *bindings,
                                             vec<vk::VertexInputAttributeDescription> *attributes) {
...
VulkanHelper::rasterization_state_create_info(vk::PolygonMode polygonMode, float line_width,
                                              vk::CullModeFlags cull_mode_flags, vk::FrontFace front_face) {
...
vk::PipelineColorBlendAttachmentState VulkanHelper::color_blend_attachment_state(vk::ColorComponentFlags colorMask,
                                                                                 bool blendEnable) {
...
vk::Pipeline VulkanHelper::PipelineBuilder::build_pipeline(vk::Device device, vk::RenderPass pass) {
    ...
    auto res =
        vkCreateGraphicsPipelines((VkDevice)device, VK_NULL_HANDLE, 1, (VkGraphicsPipelineCreateInfo *)&pipelineInfo,
                                  nullptr, (VkPipeline *)&newPipeline);
