...
<<<<<<< HEAD:CMakeSource/src/RiceEngine/src/GL/Vulkan_API_code/VulkanHelper.hpp

#include "VulkanException.hpp"
=======
>>>>>>> 39ea77fbc283d9719403cac1068eb5000c1e3c16:CMakeSource/src/RiceEngine/src/GL/VulkanHelper.hpp
...
public:
	...
	static vk::PipelineShaderStageCreateInfo pipeline_shader_stage_create_info(
			vk::ShaderStageFlagBits stage_flags,
			vk::ShaderModule shaderModule,
			const char* entrypoint = "main");

	static vk::PipelineVertexInputStateCreateInfo vertex_input_state_create_info(
			vec<vk::VertexInputBindingDescription>* bindings = nullptr,
			vec<vk::VertexInputAttributeDescription>* attributes = nullptr);

	static vk::PipelineInputAssemblyStateCreateInfo input_assembly_create_info(
	...
	static vk::PipelineMultisampleStateCreateInfo multisampling_state_create_info(
