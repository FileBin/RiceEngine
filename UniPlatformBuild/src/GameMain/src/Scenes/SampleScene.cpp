...
void SampleScene::InitResourceManager() {
	_initResourceManager(L"GameSceneResources.json");
}
...
void SampleScene::Init() {
	...
	auto& skyTex = ren.CreateTexture(resManager.GetString("SkyBoxTexture"));
	...
	but->SetImg(&ren.CreateTexture(resManager.GetString("AmogusTexture")));
	...
	pic->SetImg(&ren.CreateTexture(resManager.GetString("CrossTexture")));
	rTransform = new UI::RectTransform();
