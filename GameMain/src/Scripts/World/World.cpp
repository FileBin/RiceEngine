...
void Voxel::Register(Engine& en, SceneRender& ren) {
    ...
    registerVoxel<VoxelGrass>(en, ren);
    registerVoxel<VoxelDirt>(en, ren);
    registerVoxel<VoxelStone>(en, ren);
    registerVoxel<VoxelSnow>(en, ren);
    registerVoxel<VoxelDarkStone>(en, ren);
    registerVoxel<VoxelDarkGrass>(en, ren);
    registerVoxel<VoxelSand>(en, ren);
    registerVoxel<VoxelWater>(en, ren);
}